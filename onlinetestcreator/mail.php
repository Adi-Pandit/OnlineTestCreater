<?php
    ...
    if(isset($_GET['id']))
    {
        ...
        try 
        {
            ...
            $mail->Username   = 'adityapandit705@gmail.com';                     //SMTP username
            $mail->Password   = 'iwcegjsrsourgngz';                               //SMTP password
            $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
            $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

            //Recipients
            $mail->setFrom('adityapandit705@gmail.com', 'Aditya Pandit');
            $mail->addAddress('adityapandit705@gmail.com');     //Add a recipient
